...
from comtypes import _check_version, BSTR, CoClass, COMMETHOD, dispid, \
    DISPMETHOD, DISPPROPERTY, GUID, IUnknown
...
__all__ = [
    'OLE_ENABLEDEFAULTBOOL', 'Color', 'Font', 'VgaColor', 'IFontDisp',
    'Checked', 'StdPicture', 'Unchecked', 'IPictureDisp',
    'OLE_XSIZE_CONTAINER', 'OLE_YPOS_HIMETRIC', 'FONTSIZE',
    'OLE_XPOS_PIXELS', 'FONTNAME', 'Picture', 'OLE_XPOS_CONTAINER',
    'FONTUNDERSCORE', 'OLE_TRISTATE', 'OLE_XPOS_HIMETRIC',
    'OLE_YSIZE_HIMETRIC', 'OLE_XSIZE_PIXELS', 'OLE_YPOS_CONTAINER',
    'OLE_HANDLE', 'OLE_XSIZE_HIMETRIC', 'IFontEventsDisp', 'StdFont',
    'OLE_OPTEXCLUSIVE', 'IFont', 'Monochrome', 'FONTITALIC',
    'OLE_COLOR', 'IPicture', 'FontEvents', 'Gray', 'OLE_YPOS_PIXELS',
    'FONTBOLD', 'LoadPictureConstants', 'OLE_YSIZE_PIXELS',
    'OLE_YSIZE_CONTAINER', 'FONTSTRIKETHROUGH', 'Default',
    'OLE_CANCELBOOL'
]

_check_version('1.1.14', 1651900738.765207)
