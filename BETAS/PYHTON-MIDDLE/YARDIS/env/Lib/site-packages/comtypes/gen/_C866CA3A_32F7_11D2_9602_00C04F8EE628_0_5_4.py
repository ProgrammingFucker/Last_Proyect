...
from comtypes import _check_version, BSTR, CoClass, COMMETHOD, dispid, \
    DISPMETHOD, GUID, helpstring, IServiceProvider, IUnknown, wireHWND
...
__all__ = [
    'SPPARTOFSPEECH', 'SAFT48kHz16BitMono', 'DISPIDSPRG',
    'SPFM_NUM_MODES', 'DISPID_SpeechPhraseRule',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'ISpPhoneticAlphabetConverter', 'ISpStreamFormatConverter',
    'SpObjectTokenCategory', 'DISPID_SOTCreateInstance',
    'DISPID_SOTRemove', 'SRERequestUI', 'SPAUDIOBUFFERINFO',
    'DISPID_SRGetPropertyString', 'DISPID_SPPParent',
    'SpeechTokenKeyAttributes', 'DISPID_SVResume', 'DISPID_SLWType',
    'Speech_StreamPos_Asap', 'SPEI_UNDEFINED',
    'DISPIDSPTSI_SelectionLength', 'SAFTGSM610_44kHzMono',
    'SPPS_Modifier', 'eLEXTYPE_PRIVATE1', 'SASPause',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SPEs_NewEnum',
    'SRSEIsSpeaking', 'SVEAudioLevel', 'SVSFPersistXML',
    'SREPropertyNumChange', 'SP_VISEME_10', 'DISPID_SOTIsUISupported',
    'DISPID_SRRGetXMLErrorInfo', 'SPEI_TTS_AUDIO_LEVEL',
    'SAFT24kHz8BitMono', 'SRERecognition', 'SPDKL_LocalMachine',
    'SpeechRetainedAudioOptions', 'ISpPhoneConverter',
    'DISPID_SpeechLexiconWords', 'SpeechEmulationCompareFlags',
    '_ISpeechRecoContextEvents', 'SGDSActiveWithAutoPause',
    'SREHypothesis', 'SRSEDone', 'SpeechPartOfSpeech', 'ISpeechAudio',
    'DISPID_SOTCId', 'SAFTGSM610_11kHzMono', 'DISPID_SVEBookmark',
    'DISPID_SRGIsPronounceable', 'DISPID_SRGCmdSetRuleIdState',
    'SAFT11kHz16BitStereo', 'SPLOADOPTIONS', 'SpeechRecoContextState',
    'DISPID_SLAddPronunciation', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SpeechCategoryAudioIn', 'DISPID_SLWsItem',
    'SGDSActiveUserDelimited', 'SDTProperty',
    'DISPID_SpeechMemoryStream', 'SpeechUserTraining', 'SINoSignal',
    'DISPID_SOTDisplayUI', 'SREInterference', 'eLEXTYPE_PRIVATE17',
    'SPEI_RESERVED5', 'DISPID_SRRSaveToMemory',
    'DISPID_SpeechMMSysAudio', 'ISpeechMMSysAudio', 'SPSLMA',
    'SpInprocRecognizer', 'SpUnCompressedLexicon',
    'DISPID_SWFEExtraData', 'SPAO_RETAIN_AUDIO',
    'DISPID_SPRuleEngineConfidence', 'SPWT_PRONUNCIATION',
    'DISPID_SVSLastResult', 'DISPID_SVSRunningState',
    'DISPID_SRRAlternates', 'SRESoundStart', 'SP_VISEME_21',
    'SVEPrivate', 'SPPS_RESERVED2', 'DISPID_SRIsShared',
    'SAFT22kHz16BitStereo', 'SpeechCategoryAppLexicons',
    'SDTDisplayText', 'SDTLexicalForm',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE8', 'ISpeechBaseStream', 'SECFIgnoreKanaType',
    'DISPID_SLPPhoneIds', 'SP_VISEME_13', 'DISPID_SRCEHypothesis',
    'ISpeechDataKey', 'SDA_No_Trailing_Space', 'SpSharedRecognizer',
    'SVPAlert', 'SAFTCCITT_uLaw_8kHzMono', 'SpeechRuleState',
    'DISPID_SRGetFormat', 'SSTTWildcard', 'SBOPause',
    'DISPID_SRGCommit', 'SPEI_MIN_SR', 'SpeechTokenShellFolder',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SVSInputWordLength',
    'SITooSlow', 'ISpeechGrammarRuleStateTransition',
    'ISpPhoneticAlphabetSelection', 'ISpResourceManager',
    'DISPID_SDKGetStringValue', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SRGSetWordSequenceData', 'STCInprocHandler',
    'DISPID_SPPEngineConfidence', 'DISPID_SPRuleConfidence',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SpeechPhraseElement', 'SpStream', 'SAFTDefault',
    'DISPID_SLPs_NewEnum', 'SpLexicon', 'SPEI_PROPERTY_STRING_CHANGE',
    'SVF_None', 'DISPID_SGRSTText', 'DISPID_SAStatus',
    'ISpeechPhraseElements', 'SPSHT_OTHER',
    'DISPID_SDKSetBinaryValue', 'SPEI_PHONEME', 'ISpShortcut',
    'SAFT48kHz8BitMono', 'SAFT16kHz16BitMono', 'SP_VISEME_15',
    'DISPID_SPEAudioStreamOffset', 'SpCompressedLexicon',
    'DISPID_SRCEAudioLevel', 'SPEVENT', 'SpeechStreamFileMode',
    'SDKLCurrentUser', 'DISPID_SRGState', 'SFTSREngine',
    'SAFT22kHz16BitMono', 'ISpeechAudioBufferInfo', 'SP_VISEME_5',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SPPChildren', 'eLEXTYPE_USER',
    'DISPID_SPIElements', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SPIAudioSizeTime',
    'ISpeechObjectTokens', 'DISPID_SpeechCustomStream',
    'SPAR_Unknown', 'DISPID_SpeechPhoneConverter', 'ISpPhrase',
    'DISPID_SVGetVoices', 'DISPID_SGRsAdd',
    'DISPID_SRCCreateResultFromMemory', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRIsUISupported', 'DISPID_SGRSTransitions',
    'DISPID_SRRRecoContext', 'SpeechWordType',
    'DISPID_SWFEBlockAlign', 'SPXMLRESULTOPTIONS',
    'DISPID_SpeechBaseStream', 'DISPID_SPAsCount', 'SPVPRI_NORMAL',
    'DISPID_SLRemovePronunciation', 'DISPID_SDKDeleteValue',
    'SAFT44kHz16BitStereo', 'DISPID_SVPriority',
    'ISpeechCustomStream', 'SWPUnknownWordUnpronounceable',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SpeechXMLRecoResult',
    'SPGS_EXCLUSIVE', 'DISPID_SGRSTWeight', 'DISPID_SPRuleParent',
    'DISPID_SGRAddResource', 'DISPID_SRSCurrentStreamNumber',
    'ISpRecoGrammar2', 'ISpeechPhraseRules', 'SPWORDPRONUNCIATION',
    'SPSInterjection', 'DISPID_SRSetPropertyString', 'SRESoundEnd',
    'SpeechTokenValueCLSID', 'ISpEventSink',
    'DISPID_SOTGetDescription', 'ISpeechAudioStatus',
    'DISPID_SDKEnumValues', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SpeechVoiceEvent', 'SPVPRI_ALERT',
    'DISPID_SABufferNotifySize', 'DISPID_SPEsItem',
    'SPCT_SUB_COMMAND', 'SDTAll', 'DISPID_SVGetAudioInputs',
    'SpeechTokenContext', 'DISPID_SRCERecognitionForOtherContext',
    'SECHighConfidence', 'SVEVoiceChange', 'SPWF_INPUT',
    'SAFT24kHz8BitStereo', 'SPBO_TIME_UNITS', 'DISPID_SGRsDynamic',
    'DISPID_SDKOpenKey', 'DISPID_SRGRules', 'DISPID_SPACommit',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpPhoneticAlphabetConverter', 'ISpeechLexicon',
    'SpeechVoiceSpeakFlags', 'SPEI_HYPOTHESIS', 'SPSHORTCUTPAIRLIST',
    'SAFT32kHz8BitStereo', 'SAFT44kHz8BitMono', 'SLTApp',
    'SVSFVoiceMask', 'SVEEndInputStream', 'IStream',
    '__MIDL_IWinTypes_0009', 'DISPID_SVSLastBookmarkId',
    'SGRSTTDictation', 'DISPID_SGRs_NewEnum', 'SPPS_Interjection',
    'SpInProcRecoContext', 'SpeechRuleAttributes',
    'SPDKL_DefaultLocation', 'DISPID_SGRsItem', 'DISPID_SASState',
    'SPPS_Verb', 'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SDKEnumKeys',
    'DISPID_SWFEAvgBytesPerSec', 'SpeechAllElements',
    'DISPID_SPRNumberOfElements', 'DISPID_SPRules_NewEnum',
    'SPINTERFERENCE_NONE', 'DISPID_SVEVoiceChange', 'SGRSTTEpsilon',
    'DISPID_SGRsCount', 'STCAll', 'SECFEmulateResult', 'SINone',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SLGetPronunciations', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SPRuleName', 'SPINTERFERENCE_NOSIGNAL', 'SRSActiveAlways',
    'DISPID_SRGSetTextSelection', 'SGLexical', 'SPPHRASE',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SVSkip',
    'DISPID_SpeechPhraseElements', 'SPEI_VISEME', 'DISPID_SRGId',
    'DISPID_SPPName', 'SpeechLexiconType', 'SRATopLevel',
    'SRSInactive', 'SAFT8kHz8BitStereo', 'SRTStandard',
    'SpeechPropertyLowConfidenceThreshold', 'eLEXTYPE_PRIVATE6',
    'ISpRecoResult', 'SVSFUnusedFlags', 'SPSNotOverriden',
    'SAFT22kHz8BitMono', 'SPEI_TTS_PRIVATE', 'SPSSuppressWord',
    'SpAudioFormat', 'DISPID_SVEventInterests', 'DISPID_SRRTimes',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRRDiscardResultInfo', 'SPEI_RESERVED1', 'SVSFParseSsml',
    'SFTInput', 'DISPID_SLWLangId', 'SVP_0',
    'DISPID_SLAddPronunciationByPhoneIds', 'tagSPTEXTSELECTIONINFO',
    'ISpeechPhraseInfo', 'SPCATEGORYTYPE', 'DISPID_SGRInitialState',
    'eLEXTYPE_PRIVATE4', 'SGSDisabled', 'SP_VISEME_18',
    'SpeechRegistryLocalMachineRoot',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPSUnknown',
    'DISPID_SRCCreateGrammar', 'DISPID_SOTCGetDataKey', 'SPAR_Low',
    'DISPID_SLGenerationId', 'DISPID_SLWs_NewEnum',
    'DISPID_SVEStreamEnd', 'eWORDTYPE_DELETED', 'SVP_11', 'SPSNoun',
    'UINT_PTR', 'SPRECOCONTEXTSTATUS', 'SVSFIsNotXML',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SVWaitUntilDone',
    'SpMMAudioOut', 'DISPID_SGRSTPropertyValue', 'SRADynamic',
    'DISPID_SRCEStartStream', 'DISPID_SVSLastBookmark',
    'DISPID_SVSLastStreamNumberQueued', 'ISpeechXMLRecoResult',
    'DISPID_SPRText', '_SPAUDIOSTATE', 'SPWT_LEXICAL', 'SVSFNLPMask',
    'eLEXTYPE_PRIVATE11', '_RemotableHandle', 'ISpeechWaveFormatEx',
    'ISpDataKey', 'SPWORD', 'DISPID_SPEDisplayAttributes',
    'SPEI_SOUND_END', 'DISPID_SpeechRecognizer', 'SPLO_DYNAMIC',
    'SPSEMANTICERRORINFO', 'SREStreamStart', 'SP_VISEME_3',
    'SDTPronunciation', 'SPRS_ACTIVE_USER_DELIMITED',
    'SAFT16kHz16BitStereo', 'DISPID_SPEsCount',
    'IInternetSecurityManager', 'SVEWordBoundary',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SpeechVoice',
    'DISPID_SLGetWords', 'DISPID_SLWWord', 'SAFT32kHz8BitMono',
    'SITooFast', 'SAFTADPCM_44kHzMono',
    'DISPID_SpeechRecoResultTimes', 'SVP_18', 'SPPHRASEELEMENT',
    'SP_VISEME_14', 'SPINTERFERENCE', 'SPXRO_Alternates_SML',
    'DISPID_SRStatus', 'SPPHRASEPROPERTY', 'SREAudioLevel',
    'DISPID_SVVolume', 'SPEI_END_INPUT_STREAM', 'STSF_AppData',
    'SpWaveFormatEx', 'SGSEnabled', 'SVP_17',
    'DISPID_SPISaveToMemory', 'SPCS_DISABLED',
    'DISPID_SRSAudioStatus', 'ISpMMSysAudio', 'DISPID_SGRSTRule',
    'SRTAutopause', 'SVSFParseMask', 'SpeechAudioProperties',
    'DISPID_SPRsItem', 'DISPID_SpeechLexiconWord',
    'DISPID_SLGetGenerationChange', 'SPDKL_CurrentUser',
    'SpNotifyTranslator', 'ISpEventSource', 'SVP_13',
    'DISPID_SPERequiredConfidence', 'SPSModifier', 'SGRSTTWildcard',
    'DISPID_SPRuleChildren', 'eLEXTYPE_PRIVATE19',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SVSpeakStream', 'SPEI_END_SR_STREAM', 'SPVPRIORITY',
    'SP_VISEME_12', 'SP_VISEME_17', 'DISPID_SLPType', 'SVPNormal',
    'SREBookmark', 'DISPID_SVEStreamStart', 'SpMemoryStream',
    'DISPID_SRCESoundStart', 'DISPID_SVAlertBoundary',
    'DISPID_SRCEPhraseStart', 'DISPID_SpeechRecoResult2',
    'DISPID_SGRSTs_NewEnum', 'ISpeechRecoContext',
    'SpeechWordPronounceable', 'DISPID_SpeechRecoContextEvents',
    'SASStop', 'tagSTATSTG', 'DISPID_SVSInputWordPosition',
    'SPRST_NUM_STATES', 'DISPID_SOTCDefault', 'SSTTDictation',
    'DISPID_SRAudioInput', 'DISPID_SBSFormat',
    'SpeechCategoryRecognizers', 'DISPID_SBSSeek',
    'ISequentialStream', 'DISPID_SAFGuid', 'SP_VISEME_9',
    'DISPID_SRCVoice', 'DISPID_SPIRule', 'SVPOver', 'DISPID_SVVoice',
    'SPAS_PAUSE', 'SPSMF_SRGS_SAPIPROPERTIES', 'SPPHRASERULE',
    'DISPID_SPRDisplayAttributes', 'DISPID_SPELexicalForm',
    'SPVISEMES', 'SAFTCCITT_ALaw_22kHzStereo', 'SVP_7',
    'SPCS_ENABLED', 'SREFalseRecognition',
    'DISPID_SRRSetTextFeedback', 'SPVPRI_OVER', 'DISPID_SPRuleId',
    'SVSFIsFilename', 'DISPID_SVSPhonemeId', 'SPRECOSTATE',
    'ISpeechPhraseProperty', 'SDTRule', 'DISPID_SpeechObjectToken',
    'SpeechDiscardType', 'eLEXTYPE_PRIVATE13', 'SPLEXICONTYPE',
    'SPEI_SR_RETAINEDAUDIO', 'SRSInactiveWithPurge',
    'DISPID_SRRAudio', 'DISPID_SABIMinNotification',
    'DISPID_SpeechVoiceStatus', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPSTREAMFORMATTYPE', 'SAFTADPCM_11kHzStereo',
    'DISPID_SpeechDataKey', 'DISPID_SRGetPropertyNumber',
    'eWORDTYPE_ADDED', 'DISPID_SRProfile',
    'SPRST_INACTIVE_WITH_PURGE', 'SpeechEngineConfidence',
    'DISPID_SPEAudioSizeTime', 'SVP_10', 'DISPID_SRGetRecognizers',
    'SPWAVEFORMATTYPE', 'DISPID_SRCEPropertyNumberChange',
    'SDA_One_Trailing_Space', 'DISPID_SRCEInterference',
    'DISPIDSPTSI_SelectionOffset', 'SPPS_Noun', 'SPPHRASEREPLACEMENT',
    'DISPID_SPPValue', 'SAFTNonStandardFormat', 'SPEI_RECOGNITION',
    'SAFTADPCM_8kHzStereo', 'SVSFDefault', 'DISPID_SGRsCommitAndSave',
    'ISpeechResourceLoader', 'DISPID_SPRulesCount',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechPhraseReplacements', 'ISpGrammarBuilder',
    'DISPID_SPRFirstElement', 'SVEBookmark', 'DISPID_SVAudioOutput',
    'ISpeechObjectTokenCategory', 'DISPID_SRSetPropertyNumber',
    'SVP_3', 'SPSERIALIZEDRESULT',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPSEMANTICFORMAT',
    'SVP_20', 'SpeechRecoProfileProperties', 'SPBO_AHEAD',
    'DISPID_SLPsCount', 'SAFT8kHz8BitMono',
    'DISPID_SVSCurrentStreamNumber',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SpeechLexicon',
    'ISpeechRecoGrammar', 'SRTSMLTimeout', 'ISpeechPhraseElement',
    'SpFileStream', 'SAFTCCITT_ALaw_11kHzMono', 'SREAllEvents',
    'DISPID_SOTCategory', 'DISPID_SFSClose', 'SPEI_SOUND_START',
    'DISPID_SMSADeviceId', 'SRAInterpreter', 'SAFT24kHz16BitMono',
    'SpeechRecognizerState', 'SRSActive', 'SITooLoud',
    'DISPID_SRRTTickCount', 'DISPID_SpeechPhraseReplacement',
    'SAFTText', 'SAFT24kHz16BitStereo', 'DISPID_SRDisplayUI',
    'SPDATAKEYLOCATION', 'SLODynamic',
    'DISPID_SPERetainedStreamOffset', 'SPFM_CREATE',
    'DISPID_SpeechPhraseProperties', 'SpeechRunState',
    'ISpeechLexiconPronunciations', 'DISPID_SGRSTType',
    'SPEI_SR_BOOKMARK', 'DISPID_SpeechRecoContext',
    'SAFT48kHz16BitStereo', 'SRCS_Enabled', 'DISPID_SPPsItem',
    'Speech_Max_Word_Length', 'SGRSTTTextBuffer', 'SpeechLoadOption',
    'IEnumSpObjectTokens', 'SVSFPurgeBeforeSpeak', 'SP_VISEME_2',
    'SPINTERFERENCE_TOOFAST', 'SPRS_ACTIVE',
    'DISPID_SPEEngineConfidence', 'SAFT48kHz8BitStereo',
    'SpPhraseInfoBuilder', 'SpeechPropertyAdaptationOn',
    'SpeechMicTraining', 'SGPronounciation',
    'DISPID_SPEPronunciation', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SRGDictationSetState', 'SAFTADPCM_22kHzMono',
    'SRTExtendableParse', 'SPEI_MAX_TTS', 'SPWORDPRONOUNCEABLE',
    'ISpeechRecoResult', 'eLEXTYPE_PRIVATE16', 'ISpProperties',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SECNormalConfidence',
    'SPDKL_CurrentConfig', 'SPCT_SUB_DICTATION', 'DISPID_SFSOpen',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SVDisplayUI',
    'DISPID_SWFEFormatTag', 'WAVEFORMATEX', 'DISPID_SOTSetId',
    'SVSFNLPSpeakPunc', 'SREPropertyStringChange', 'DISPID_SVSpeak',
    'SREPhraseStart', 'SDKLDefaultLocation', 'SpeechCategoryVoices',
    'DISPID_SPPConfidence', 'SpeechRecoEvents',
    'DISPID_SPARecoResult', 'SDTAlternates', 'SPSHORTCUTTYPE',
    'SAFT16kHz8BitStereo', 'DISPID_SPIGetText', 'STSF_LocalAppData',
    'DISPID_SAFGetWaveFormatEx', 'ISpeechObjectToken',
    'DISPID_SRGRecoContext', 'DISPID_SLWPronunciations', 'SDTAudio',
    'DISPID_SRRecognizer', 'SPSERIALIZEDPHRASE', 'DISPID_SPPsCount',
    'SAFT32kHz16BitStereo', 'ISpVoice', 'DISPID_SPCIdToPhone',
    'SpeechEngineProperties', 'SpeechDataKeyLocation',
    'DISPID_SPIGrammarId', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SABIEventBias', 'eLEXTYPE_PRIVATE5', 'SPAS_CLOSED',
    'DISPID_SpeechAudio', 'SRERecoOtherContext', 'DISPID_SMSALineId',
    'DISPID_SRCEFalseRecognition', 'SpeechTokenIdUserLexicon',
    'ISpeechLexiconWords', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SGRName',
    'DISPID_SPERetainedSizeBytes', 'SpObjectToken',
    'SAFT32kHz16BitMono', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SPIStartTime', 'SpeechVoicePriority',
    'SpeechCategoryRecoProfiles', 'eLEXTYPE_RESERVED8',
    'SREAdaptation', 'DISPID_SRCPause', 'DISPID_SVEWord', 'SVP_2',
    'eLEXTYPE_PRIVATE7', 'SGRSTTWord', 'DISPID_SDKDeleteKey',
    'DISPID_SPILanguageId', 'DISPID_SRCERecognition', 'SPEI_MIN_TTS',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpeechPhraseInfoBuilder',
    'DISPID_SVSVisemeId', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPBO_PAUSE',
    'DISPID_SpeechGrammarRuleStateTransition', 'SAFT12kHz8BitStereo',
    'DISPID_SPRs_NewEnum', 'SP_VISEME_4', 'SGLexicalNoSpecialChars',
    'DISPID_SPIAudioSizeBytes', 'SPINTERFERENCE_LATENCY_WARNING',
    'SWPKnownWordPronounceable', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SGRSAddRuleTransition', 'SPAR_Medium', 'SPCT_COMMAND',
    'SRADefaultToActive', 'SpeechAudioFormatType',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SVEAudioLevel',
    'DISPID_SVEEnginePrivate', 'DISPID_SOTId', 'eLEXTYPE_RESERVED6',
    'SGDisplay', 'SVP_1', 'SpeechGrammarTagWildcard',
    'DISPID_SRGCmdLoadFromFile', 'SGRSTTRule', 'SPGRAMMARSTATE',
    'SPFM_OPEN_READWRITE', 'DISPID_SRRTLength', 'DISPID_SABufferInfo',
    'tagSPPROPERTYINFO', 'SPAO_NONE', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPIEnginePrivateData', 'SPWT_DISPLAY', 'SPCT_SLEEP',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SpeechAudioStatus', 'SAFT22kHz8BitStereo',
    'SAFTADPCM_22kHzStereo', 'DISPID_SPEAudioTimeOffset',
    'eLEXTYPE_RESERVED4', 'SRARoot', 'DISPID_SPIProperties',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRCSetAdaptationData',
    'SPAR_High', 'SRTEmulated', 'ISpeechRecognizer', 'SVF_Stressed',
    'SpeechVisemeType', 'DISPID_SGRsFindRule',
    'SpeechRecognitionType', 'IInternetSecurityMgrSite', 'SVP_14',
    'DISPID_SBSWrite', 'SAFT44kHz8BitStereo', 'SpShortcut',
    'SpMMAudioIn', 'DISPID_SASFreeBufferSpace', 'ISpeechVoiceStatus',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRGDictationUnload', 'DISPID_SGRsCommit', 'SP_VISEME_1',
    'SpeechAudioVolume', 'LONG_PTR', 'SPSHT_EMAIL', 'SGDSInactive',
    'Speech_Default_Weight', 'DISPID_SREmulateRecognition',
    'DISPID_SGRSRule', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRRAudioFormat',
    'SP_VISEME_6', 'DISPID_SpeechPhraseRules', 'SpeechTokenKeyFiles',
    'ISpeechGrammarRuleState', 'eLEXTYPE_RESERVED9',
    'DISPID_SGRSTsItem', 'SDA_Two_Trailing_Spaces', 'SVP_8',
    'DISPID_SVEPhoneme', 'DISPID_SOTsItem', 'ISpeechRecoResultTimes',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SGRSTPropertyName', 'SRAONone',
    'ISpRecognizer', 'IEnumString', 'ISpeechPhraseAlternates',
    'SPEI_RECO_STATE_CHANGE', 'SVEViseme', 'DISPID_SLPsItem',
    'DISPID_SVSInputSentenceLength', 'SVEStartInputStream',
    'ISpeechPhraseProperties', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPEI_INTERFERENCE', 'SPSHORTCUTPAIR', 'DISPID_SPRsCount',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPCPhoneToId',
    'ISpeechPhraseReplacement', 'DISPID_SVIsUISupported',
    'SpeechStreamSeekPositionType', 'SAFT16kHz8BitMono',
    'DISPID_SRGDictationLoad', 'DISPID_SDKSetStringValue',
    'DISPID_SVRate', 'SPPS_RESERVED1', 'DISPID_SpeechGrammarRules',
    'SpeechGrammarState', 'SVP_12', 'SLOStatic',
    'DISPID_SVSInputSentencePosition', 'ISpRecoContext', 'SWTDeleted',
    'STSF_CommonAppData', 'SpCustomStream', 'ISpObjectTokenCategory',
    'ISpLexicon', 'DISPID_SpeechAudioBufferInfo', 'SPEI_MAX_SR',
    'SPADAPTATIONRELEVANCE', 'SPCT_DICTATION', 'SVEAllEvents',
    'DISPID_SPPFirstElement', 'SREPrivate', 'SPVOICESTATUS',
    'SECFNoSpecialChars', 'DISPID_SPAStartElementInResult',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SWFEChannels', 'SPEI_RESERVED3', 'DISPID_SASetState',
    'SPRECOGNIZERSTATUS', 'SGSExclusive', 'DISPID_SABIBufferSize',
    'SPGS_DISABLED', 'SVEPhoneme',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SVP_19', 'SREStreamEnd',
    'DISPID_SOTMatchesAttributes', 'ISpRecognizer3',
    'ISpRecoContext2', 'SRAImport', 'SASClosed', 'SPRST_ACTIVE',
    'DISPID_SPEActualConfidence', 'SP_VISEME_11', 'DISPID_SPPId',
    'SAFTNoAssignedFormat', 'SpeechBookmarkOptions',
    'DISPID_SRRPhraseInfo', 'DISPID_SpeechFileStream',
    'eLEXTYPE_PRIVATE20', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SAFTADPCM_11kHzMono', 'SPSHT_NotOverriden', 'SPSMF_UPS',
    'SpNullPhoneConverter', 'ISpStreamFormat',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SpeechGrammarRule',
    'DISPID_SRCState', 'DISPID_SOTCEnumerateTokens',
    'SpeechInterference', 'DISPID_SRCRecognizer',
    'SpeechPropertyResourceUsage', 'SPEVENTENUM',
    'ISpObjectWithToken', 'SpeechTokenKeyUI', 'SVP_5',
    'SAFT11kHz8BitStereo', 'SVP_6', 'SPBINARYGRAMMAR',
    'SpSharedRecoContext', 'SPEI_RESERVED2',
    'DISPID_SVAudioOutputStream', 'DISPID_SOTsCount',
    'eLEXTYPE_RESERVED10', 'SRAExport', 'SpeechCategoryAudioOut',
    'eLEXTYPE_PRIVATE15', 'DISPID_SLPLangId', 'SSFMCreate', 'SVP_21',
    'SPPS_SuppressWord', 'DISPID_SGRSTPropertyId',
    'SAFT44kHz16BitMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SPBO_NONE',
    'SpeechVoiceEvents', 'SVP_9', 'SREStateChange',
    'ISpeechFileStream', 'DISPID_SPAs_NewEnum', 'ISpNotifySource',
    'DISPID_SOTCSetId', 'SAFT12kHz16BitMono', 'SpMMAudioEnum',
    'SPEI_SR_PRIVATE', 'DISPID_SASNonBlockingIO', 'SPPROPERTYINFO',
    'SPEI_START_INPUT_STREAM', 'SPPS_Noncontent',
    'DISPID_SPANumberOfElementsInResult', 'ISpeechPhraseReplacements',
    'SPAUDIOSTATE', 'DISPID_SGRSAddSpecialTransition',
    'SPEI_SENTENCE_BOUNDARY', 'STCRemoteServer',
    'DISPID_SpeechObjectTokens', 'SPLO_STATIC', 'SVP_15',
    'SPWORDPRONUNCIATIONLIST', 'SDA_Consume_Leading_Spaces',
    'SpeechDisplayAttributes', 'DISPID_SMSAMMHandle',
    'SPPS_RESERVED4', 'SRCS_Disabled', 'SP_VISEME_0',
    'SSFMOpenForRead', 'eLEXTYPE_PRIVATE2',
    'SpeechDictationTopicSpelling', 'DISPID_SDKGetBinaryValue',
    'Speech_StreamPos_RealTime', 'eLEXTYPE_RESERVED7',
    'DISPID_SASCurrentDevicePosition', 'SPFM_CREATE_ALWAYS',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SpeechPhraseInfo',
    'DISPID_SRSClsidEngine', 'SpeechAddRemoveWord',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPAsItem',
    'STCLocalServer', 'SpeechAudioFormatGUIDWave', 'SRTReSent',
    'DISPID_SRCEEnginePrivate', 'SPEVENTSOURCEINFO',
    'DISPID_SWFESamplesPerSec', 'SPPS_RESERVED3',
    '_ISpeechVoiceEvents', 'SSFMOpenReadWrite', 'SBONone',
    'SPEI_PHRASE_START', 'SP_VISEME_16',
    'DISPID_SOTGetStorageFileName', 'SpeechGrammarTagDictation',
    'SpeechAudioState', 'DISPID_SVStatus', 'SVP_16',
    'DISPID_SpeechLexiconProns', 'SLTUser', 'ISpeechRecognizerStatus',
    'SPAS_STOP', 'ISpRecoGrammar', 'SAFTGSM610_22kHzMono',
    'SpeechPropertyComplexResponseSpeed', 'ISpAudio',
    'DISPID_SPRulesItem', 'DISPID_SRCERecognizerStateChange',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'ISpeechTextSelectionInformation', 'SpTextSelectionInformation',
    'DISPID_SPRuleFirstElement', 'DISPID_SGRAddState', 'ISpPhraseAlt',
    'SPRECORESULTTIMES', 'DISPID_SRSSupportedLanguages',
    'DISPID_SRCreateRecoContext', 'DISPID_SGRSTNextState',
    'SWPUnknownWordPronounceable', 'SP_VISEME_19',
    'DISPID_SRCERequestUI', 'SPTEXTSELECTIONINFO',
    'SpStreamFormatConverter', 'DISPID_SBSRead',
    'DISPID_SRCRetainedAudioFormat', 'SPAUDIOOPTIONS',
    'DISPID_SRCEventInterests',
    'SpeechPropertyHighConfidenceThreshold', 'SSSPTRelativeToEnd',
    'SPEI_TTS_BOOKMARK', 'ISpeechMemoryStream', 'SVP_4',
    'SPEI_REQUEST_UI', 'DISPID_SGRSTsCount', 'DISPID_SCSBaseStream',
    'SPPS_NotOverriden', 'SpeechFormatType', 'SVSFParseSapi',
    'SpeechCategoryPhoneConverters', 'SPWORDTYPE',
    'DISPID_SpeechPhraseBuilder', 'ISpeechGrammarRules',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SDKCreateKey',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPAPhraseInfo',
    'SPINTERFERENCE_TOOLOUD', 'eLEXTYPE_PRIVATE10',
    'SpeechSpecialTransitionType', 'SPSFunction',
    'SAFTADPCM_44kHzStereo', 'ISpNotifyTranslator',
    'ISpeechAudioFormat', 'DISPID_SAFType', 'ISpeechPhoneConverter',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRCResume',
    'DISPID_SRGReset', 'DISPID_SADefaultFormat',
    'SAFTGSM610_8kHzMono', 'Speech_Max_Pron_Length',
    'DISPID_SpeechPhraseAlternates', 'DISPIDSPTSI', 'SPFILEMODE',
    'SRAORetainAudio', 'SECFIgnoreWidth', 'SPSHT_Unknown',
    'SVSFlagsAsync', 'SECFDefault', 'DISPID_SDKGetlongValue',
    'ISpeechRecoResultDispatch', 'SAFT11kHz8BitMono', 'SPSVerb',
    'SP_VISEME_7', 'DISPID_SVPause', 'SPRST_INACTIVE', 'SGDSActive',
    'DISPID_SRCBookmark', 'SPPS_Unknown', 'SP_VISEME_20',
    'DISPID_SGRAttributes', 'SWTAdded', 'ISpObjectToken',
    'SDKLCurrentConfig', 'eLEXTYPE_PRIVATE9', 'SAFTADPCM_8kHzMono',
    'DISPID_SRCRetainedAudio', 'SAFT8kHz16BitStereo',
    'DISPID_SLPPartOfSpeech', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFT12kHz16BitStereo', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SVESentenceBoundary', 'SPEI_VOICE_CHANGE',
    'SAFTExtendedAudioFormat', 'SpPhoneConverter',
    'DISPID_SVGetAudioOutputs', 'DISPID_SRRTStreamTime', 'SPWORDLIST',
    'ISpRecognizer2', 'SpeechGrammarWordType', 'SPBOOKMARKOPTIONS',
    'SPGRAMMARWORDTYPE', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPPs_NewEnum', 'SPPS_Function', 'SPCONTEXTSTATE',
    'STCInprocServer', 'DISPID_SGRSAddWordTransition',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SPIEngineId',
    'DISPID_SGRId', 'SPINTERFERENCE_NOISE', 'SVSFParseAutodetect',
    'SITooQuiet', 'SECFIgnoreCase', 'DISPID_SpeechPhraseProperty',
    'DISPID_SLPSymbolic', 'DISPID_SPCLangId', 'SAFT8kHz16BitMono',
    'ISpeechPhraseRule', 'SSFMCreateForWrite', 'ISpeechGrammarRule',
    'SPGS_ENABLED', 'SPAUDIOSTATUS', 'DISPID_SRState',
    'eLEXTYPE_LETTERTOSOUND', 'SPRS_INACTIVE',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRRSpeakAudio',
    'DISPID_SpeechAudioFormat', 'DISPID_SPEAudioSizeBytes',
    'SDKLLocalMachine', 'SPFM_OPEN_READONLY', 'ISpNotifySink',
    'DISPID_SVGetProfiles', 'DISPID_SRCEAdaptation',
    'ISpSerializeState', 'DISPID_SpeechRecognizerStatus',
    'eLEXTYPE_APP', 'ISpStream', 'SPEI_ADAPTATION',
    'ISpeechLexiconPronunciation', 'DISPID_SMSSetData',
    'SSSPTRelativeToStart', 'ISpRecoCategory', 'SAFT12kHz8BitMono',
    'DISPID_SpeechGrammarRuleStateTransitions',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SOTDataKey',
    'DISPID_SLWsCount', 'ISpeechRecoResult2', 'SpVoice',
    'DISPID_SRSCurrentStreamPosition', 'SPEI_RESERVED6',
    'SPEI_START_SR_STREAM', 'DISPID_SAEventHandle',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechVisemeFeature',
    'DISPID_SRCEEndStream', 'SpeechGrammarRuleStateTransitionType',
    'eLEXTYPE_PRIVATE12', 'DISPID_SPIReplacements',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SpeechRecoResult',
    'SPXRO_SML', 'SPSMF_SAPI_PROPERTIES', 'eLEXTYPE_PRIVATE14',
    'SP_VISEME_8', 'eLEXTYPE_PRIVATE18', 'DISPID_SDKSetLongValue',
    'DISPID_SRRGetXMLResult', 'DISPID_SPPNumberOfElements',
    'ISpeechLexiconWord', 'SVF_Emphasis', 'eLEXTYPE_PRIVATE3',
    'SECLowConfidence', 'DISPID_SAVolume', 'SINoise', 'SPRULE',
    'SVSFIsXML', 'STSF_FlagCreate', 'DISPID_SMSGetData', 'SASRun',
    'SVESentenceBoundary', 'DISPID_SRAudioInputStream',
    'SpeechAudioFormatGUIDText', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SPIRetainedSizeBytes', 'SPAS_RUN', 'SDTReplacement',
    'ISpeechVoice', 'SSTTTextBuffer', 'DISPID_SOTGetAttribute',
    'SpResourceManager', 'SAFT11kHz16BitMono',
    'SpeechRegistryUserRoot', 'SPPS_LMA', 'SPWF_SRENGINE',
    'DISPID_SPEDisplayText', 'DISPID_SOTs_NewEnum',
    'DISPID_SVEViseme', 'DISPID_SGRClear', 'ISpXMLRecoResult',
    'DISPID_SRCEBookmark', 'ISpeechPhraseAlternate',
    'DISPID_SRCRequestedUIType', 'DISPID_SPIAudioStreamPosition',
    'SPRULESTATE', 'SpeechPropertyResponseSpeed',
    'DISPID_SRCESoundEnd'
]

_check_version('1.1.14', 1651900785.163668)
